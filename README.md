...
- Extract and repair JSON from logs or the clipboard, then selectively parse nested strings (`leo json`).
- Search remote clipboard history and copy a selected entry (`leo clip` or `leo cb`).
